                  ...
                  children: [
                        {
                              key: '/peoples-data',
                              label: (
                                    <Link to="/peoples-data" className="text-[#6B6B6B] hover:text-white">
                                          Peoples Data
                                    </Link>
                              ),
                        },
                        {
                              key: '/companies-data',
                              label: (
                                    <Link to="/companies-data" className="text-white hover:text-white">
                                          Companies Data
                                    </Link>
                              ),
                        },
                  ...
                  children: [
                        {
                              key: '/blogs',
                              label: (
                                    <Link to="/blogs" className="text-[#6B6B6B] hover:text-white">
                                          Blogs
                                    </Link>
                              ),
                        },
                        ...
                        },
                        {
                              ...
                              label: (
                                    <Link to="/terms-and-conditions" className="text-white hover:text-white">
                                          Terms of Use
                                    </Link>
                              ),
                        },
